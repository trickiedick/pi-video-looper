...
# constants & decs
# PLAYER 1
# Use USB Stick mounted at /media/usb0 for media
...
# sleep for 10 secs to allow break out
...
while not (halting):
    ...
    time.sleep(0.05)
    # wait for input 0 (all players nc relay contacts in series - start command)
